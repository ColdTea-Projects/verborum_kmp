...
**Not installed in this repo** — the upstream package ships it at `agents/cs-skill-author.md`; the six questions below are worth asking by hand. Voice: forcing-question interrogator. Surfaces Matt's skill-authoring workflow as an interrogation before any new skill commit.
...
**Not installed in this repo** — the upstream package ships it at `commands/cs-write-a-skill.md`. Its three-step flow, worth following manually:
...
This is the hybrid voice approach: Matt's words for the principles, the wrapper's additions for the scripts.
